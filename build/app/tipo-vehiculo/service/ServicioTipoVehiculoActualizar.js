    ...
    static actualizarTipoVehiculo(objTipoVehiculo, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const tipoVehiculoExistente = yield dbConnection_1.default.oneOrNone(sql_tipoVehiculo_1.SQL_TIPO_VEHICULO.FIND_BY_ID, [objTipoVehiculo.codTipoVehiculo]);
                if (!tipoVehiculoExistente) {
                    return res.status(404).json({
                        respuesta: "El tipo de vehículo no existe",
                    });
                }
                const tiposVehiculos = yield dbConnection_1.default.one(sql_tipoVehiculo_1.SQL_TIPO_VEHICULO.HOW_MANY, [
                    objTipoVehiculo.claseTipoVehiculo,
                ]);
                ...
                const resultado = yield dbConnection_1.default.result(sql_tipoVehiculo_1.SQL_TIPO_VEHICULO.UPDATE, [
                    objTipoVehiculo.claseTipoVehiculo,
                    objTipoVehiculo.codTipoVehiculo,
                ]);
