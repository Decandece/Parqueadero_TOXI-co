        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const resultado = yield dbConnection_1.default.task((consulta) => __awaiter(this, void 0, void 0, function* () {
                    const tiposVehiculos = yield consulta.one(sql_tipoVehiculo_1.SQL_TIPO_VEHICULO.HOW_MANY, [
                        obj.claseTipoVehiculo,
                    ]);
                    if (tiposVehiculos.cantidad > 0) {
                        return { caso: 1 };
                    }
                    const objGrabado = yield consulta.one(sql_tipoVehiculo_1.SQL_TIPO_VEHICULO.ADD, [
                        obj.claseTipoVehiculo,
                    ]);
