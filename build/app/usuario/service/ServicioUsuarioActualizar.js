    ...
    static actualizarUsuario(objUsuario, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield dbConnection_1.default
                ...
                const documentos = yield consulta.oneOrNone("SELECT COUNT(u.cod_usuario) as cantidad FROM usuarios u \
          WHERE u.documento_usuario = $1 AND u.cod_usuario != $2", [objUsuario.documentoUsuario, objUsuario.codUsuario]);
