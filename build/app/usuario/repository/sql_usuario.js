...
exports.SQL_USUARIO = {
    FIND_ALL: "SELECT u.cod_usuario, u.cod_rol, u.documento_usuario, u.nombres_usuario, \
      u.apellidos_usuario, u.genero_usuario, u.fecha_nacimiento_usuario, \
      u.telefono_usuario FROM usuarios u ORDER BY u.cod_usuario",
    FIND_BY_ID: "SELECT u.cod_usuario, u.cod_rol, u.documento_usuario, u.nombres_usuario, \
      u.apellidos_usuario, u.genero_usuario, u.fecha_nacimiento_usuario, \
      u.telefono_usuario FROM usuarios u WHERE u.cod_usuario = $1",
    FIND_BY_ROL: "SELECT u.cod_usuario, u.cod_rol, u.documento_usuario, u.nombres_usuario, \
      u.apellidos_usuario, u.genero_usuario, u.fecha_nacimiento_usuario, \
      u.telefono_usuario FROM usuarios u WHERE u.cod_rol = $1",
    CHECK_DOCUMENTO: "SELECT COUNT(u.cod_usuario) as cantidad FROM usuarios u \
    ...
    UPDATE: "UPDATE usuarios SET cod_rol = $1, documento_usuario = $2, \
